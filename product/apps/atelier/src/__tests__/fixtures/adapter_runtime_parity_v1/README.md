...
Placeholder v5.1 layout scaffolding for fixture `adapter_runtime_parity_v1`.
...
`fixture_not_yet_implemented: adapter_runtime_parity_v1`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `adapter_runtime_parity_v1` in
