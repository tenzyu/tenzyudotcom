# Fixture: artifact_graph_golden_v1

Placeholder v5.1 layout scaffolding for fixture `artifact_graph_golden_v1`.
...
`fixture_not_yet_implemented: artifact_graph_golden_v1`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `artifact_graph_golden_v1` in
