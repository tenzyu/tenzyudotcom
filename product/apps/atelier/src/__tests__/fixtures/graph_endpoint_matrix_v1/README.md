...
Placeholder v5.1 layout scaffolding for fixture `graph_endpoint_matrix_v1`.
...
`fixture_not_yet_implemented: graph_endpoint_matrix_v1`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `graph_endpoint_matrix_v1` in
