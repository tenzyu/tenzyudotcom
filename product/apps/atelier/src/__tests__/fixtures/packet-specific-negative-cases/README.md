# Fixture: packet-specific-negative-cases

Placeholder v5.1 layout scaffolding for fixture `packet-specific-negative-cases`.
...
`fixture_not_yet_implemented: packet-specific-negative-cases`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `packet-specific-negative-cases` in
