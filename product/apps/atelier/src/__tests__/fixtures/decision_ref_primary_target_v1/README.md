...
Placeholder v5.1 layout scaffolding for fixture `decision_ref_primary_target_v1`.
...
`fixture_not_yet_implemented: decision_ref_primary_target_v1`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `decision_ref_primary_target_v1` in
