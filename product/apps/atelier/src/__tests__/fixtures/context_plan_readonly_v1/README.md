...
Placeholder v5.1 layout scaffolding for fixture `context_plan_readonly_v1`.
...
`fixture_not_yet_implemented: context_plan_readonly_v1`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `context_plan_readonly_v1` in
