...
Placeholder v5.1 layout scaffolding for fixture `durable_acceptance_v1`.
...
`fixture_not_yet_implemented: durable_acceptance_v1`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `durable_acceptance_v1` in
