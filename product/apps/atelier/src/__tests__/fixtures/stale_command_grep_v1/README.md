# Fixture: stale_command_grep_v1

Placeholder v5.1 layout scaffolding for fixture `stale_command_grep_v1`.
...
`fixture_not_yet_implemented: stale_command_grep_v1`. A future fixture-author
packet will replace the placeholder contents with the real input,
expected, README, and command.

## Provenance

See the registry row for `stale_command_grep_v1` in
