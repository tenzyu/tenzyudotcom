...
const surfaceVariants = cva('border text-card-foreground', {
  variants: {
    variant: {
      default:
        'rounded-[var(--radius-xl)] border-border/70 bg-card shadow-[var(--shadow-surface)]',
      ...
      warning:
        'rounded-[var(--radius-lg)] border-warning/45 bg-warning/12 text-foreground',
      danger:
        'rounded-[var(--radius-lg)] border-destructive/45 bg-destructive/10 text-foreground',
      success:
        'rounded-[var(--radius-lg)] border-success/45 bg-success/10 text-foreground',
    },
    padding: {
      none: 'p-0',
      sm: 'p-3',
