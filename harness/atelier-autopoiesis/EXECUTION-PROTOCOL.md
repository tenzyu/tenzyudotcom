...
```txt
1. Mission compiler builds or refreshes a capability map from MISSION.md and repository state.
...
7. Coordinator either dispatches repairs or completes only on evaluator pass.
```
