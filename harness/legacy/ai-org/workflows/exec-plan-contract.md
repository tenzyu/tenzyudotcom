...
`harness/ai-org/exec-plans/active/*.md` holds both notes and delegation-ready plans.
...
- Treat `harness/ai-org/exec-plans/completed/*.md` as work logs, not canonical rules.
