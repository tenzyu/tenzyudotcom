...
read_when:
  - harness/ai-org/knowledge/design-docs/rules を template 準拠で再編するとき
...
- `harness/ai-org/exec-plans/active/design-doc-rules-harness-refactor.md`
...
- `lint-rules` の責務を `harness/ai-org/knowledge/design-docs/**` の lint に限定した
...
- plan path: `harness/ai-org/exec-plans/active/design-doc-rules-harness-refactor.md`
- allowed file scope:
  - `harness/ai-org/knowledge/design-docs/**`
  - `harness/ai-org/exec-plans/active/design-doc-rules-harness-refactor.md`
  - `scripts/lint-rules.ts`
