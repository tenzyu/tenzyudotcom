...
schema: harness/v1
kind: run
id: run.active.run-harness-knowledge-steps-2-10-tag-taxonomy-definition-front-52bdc9f596.context
title: "RUN-harness-knowledge-steps-2-10-tag-taxonomy-definition-front-52bdc9f596 Context"
status: active
summary: "Compiled context pack for Steps 2-10: Tag Taxonomy definition, frontmatter migration, role selector update, Context Compiler update, Resolution Trace, Relation Resolver, Validator, Affordance Pipeline, meta-workflow harnessization"
tags:
  - harness
  - context
---

# Context: RUN-harness-knowledge-steps-2-10-tag-taxonomy-definition-front-52bdc9f596
...
- Target path: `harness/knowledge`
- Intent: Steps 2-10: Tag Taxonomy definition, frontmatter migration, role selector update, Context Compiler update, Resolution Trace, Relation Resolver, Validator, Affordance Pipeline, meta-workflow harnessization
...
- `harness/knowledge`
- `harness/runs/active/RUN-harness-knowledge-steps-2-10-tag-taxonomy-definition-front-52bdc9f596`
...
- `harness/knowledge/decisions/adr/0001-ai-org-standard.md` - optional role knowledge matched metadata signals for intent 'Steps 2-10: Tag Taxonomy definition, frontmatter migration, role selector update, Context Compiler update, Resolution Trace, Relation Resolver, Validator, Affordance Pipeline, meta-workflow harnessization'
- `harness/knowledge/decisions/adr/0004-ai-org-llm-doc-consolidation.md` - optional role knowledge matched metadata signals for intent 'Steps 2-10: Tag Taxonomy definition, frontmatter migration, role selector update, Context Compiler update, Resolution Trace, Relation Resolver, Validator, Affordance Pipeline, meta-workflow harnessization'
...
- `harness/knowledge/rules/intelligence/intelligence-decision-policy.md` - optional role knowledge matched metadata signals for intent 'Steps 2-10: Tag Taxonomy definition, frontmatter migration, role selector update, Context Compiler update, Resolution Trace, Relation Resolver, Validator, Affordance Pipeline, meta-workflow harnessization'
- `harness/knowledge/rules/intelligence/intelligence-harness-memory-model.md` - optional role knowledge matched metadata signals for intent 'Steps 2-10: Tag Taxonomy definition, frontmatter migration, role selector update, Context Compiler update, Resolution Trace, Relation Resolver, Validator, Affordance Pipeline, meta-workflow harnessization'; role selectors matched tags, knowledge type, and metadata signals
...
`atelier run close RUN-harness-knowledge-steps-2-10-tag-taxonomy-definition-front-52bdc9f596`
