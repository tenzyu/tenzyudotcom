...
schema: harness/v1
kind: run
id: run.active.run-product-apps-atelier-implement-and-release-atelier-m9-mcp-ser-9b2bd07336.context
title: "RUN-product-apps-atelier-implement-and-release-atelier-m9-mcp-ser-9b2bd07336 Context"
status: active
summary: "Compiled context pack for Implement and release Atelier M9 (MCP server) and M10 (GUI)"
tags:
  - harness
  - context
---

# Context: RUN-product-apps-atelier-implement-and-release-atelier-m9-mcp-ser-9b2bd07336
...
- Intent: Implement and release Atelier M9 (MCP server) and M10 (GUI)
...
- `harness/runs/active/RUN-product-apps-atelier-implement-and-release-atelier-m9-mcp-ser-9b2bd07336`
...
`atelier run close RUN-product-apps-atelier-implement-and-release-atelier-m9-mcp-ser-9b2bd07336`
