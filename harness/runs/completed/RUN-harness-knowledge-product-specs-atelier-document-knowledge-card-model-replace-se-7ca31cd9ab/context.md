...
schema: harness/v1
kind: run
id: run.active.run-harness-knowledge-product-specs-atelier-document-knowledge-card-model-replace-se-7ca31cd9ab.context
title: "RUN-harness-knowledge-product-specs-atelier-document-knowledge-card-model-replace-se-7ca31cd9ab Context"
status: active
summary: "Compiled context pack for Document Knowledge Card Model: replace section 6.3 with Knowledge Card Model, add sections 6.4 Dendritic Patterns, 6.5 Tag Taxonomy, 6.6 Resolution Trace to atelier product-spec"
tags:
  - harness
  - context
---

# Context: RUN-harness-knowledge-product-specs-atelier-document-knowledge-card-model-replace-se-7ca31cd9ab
...
- Roles: `role.domain.harness-engineer`
- Target path: `harness/knowledge/product-specs/atelier`
- Intent: Document Knowledge Card Model: replace section 6.3 with Knowledge Card Model, add sections 6.4 Dendritic Patterns, 6.5 Tag Taxonomy, 6.6 Resolution Trace to atelier product-spec
...
- `harness/runs/active/RUN-harness-knowledge-product-specs-atelier-document-knowledge-card-model-replace-se-7ca31cd9ab`
...
Reason: pinned by role 'role.domain.harness-engineer'; repository policy; required by role 'role.domain.harness-engineer'
...
- `harness/knowledge/decisions/adr/0001-ai-org-standard.md` - optional role knowledge matched metadata signals for intent 'Document Knowledge Card Model: replace section 6.3 with Knowledge Card Model, add sections 6.4 Dendritic Patterns, 6.5 Tag Taxonomy, 6.6 Resolution Trace to atelier product-spec'
- `harness/knowledge/decisions/adr/0004-ai-org-llm-doc-consolidation.md` - optional role knowledge matched metadata signals for intent 'Document Knowledge Card Model: replace section 6.3 with Knowledge Card Model, add sections 6.4 Dendritic Patterns, 6.5 Tag Taxonomy, 6.6 Resolution Trace to atelier product-spec'
- `harness/knowledge/incidents/README.md` - known problem or incident matched metadata signals
- `harness/knowledge/index.md` - role selectors matched tags, knowledge type, and metadata signals
...
- `harness/knowledge/product-specs/atelier/README.md` - role selectors matched tags, knowledge type, and metadata signals
- `harness/knowledge/product-specs/atelier/ROADMAP.md` - role selectors matched tags, knowledge type, and metadata signals
- `harness/knowledge/roadmap.md` - role selectors matched tags, knowledge type, and metadata signals
- `harness/knowledge/rules/intelligence/intelligence-decision-policy.md` - optional role knowledge matched metadata signals for intent 'Document Knowledge Card Model: replace section 6.3 with Knowledge Card Model, add sections 6.4 Dendritic Patterns, 6.5 Tag Taxonomy, 6.6 Resolution Trace to atelier product-spec'
- `harness/knowledge/rules/intelligence/intelligence-harness-memory-model.md` - optional role knowledge matched metadata signals for intent 'Document Knowledge Card Model: replace section 6.3 with Knowledge Card Model, add sections 6.4 Dendritic Patterns, 6.5 Tag Taxonomy, 6.6 Resolution Trace to atelier product-spec'; role selectors matched tags, knowledge type, and metadata signals
...
`atelier run close RUN-harness-knowledge-product-specs-atelier-document-knowledge-card-model-replace-se-7ca31cd9ab`
