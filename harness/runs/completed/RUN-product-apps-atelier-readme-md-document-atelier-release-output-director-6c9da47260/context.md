...
schema: harness/v1
kind: run
id: run.active.run-product-apps-atelier-readme-md-document-atelier-release-output-director-6c9da47260.context
title: "RUN-product-apps-atelier-readme-md-document-atelier-release-output-director-6c9da47260 Context"
status: active
summary: "Compiled context pack for Document Atelier release output directory in README"
tags:
  - harness
  - context
---

# Context: RUN-product-apps-atelier-readme-md-document-atelier-release-output-director-6c9da47260
...
- Workflow: `workflow.direct-run`
- Roles: `role.domain.harness-engineer`
- Target path: `product/apps/atelier/README.md`
- Intent: Document Atelier release output directory in README
...
- `harness/runs/active/RUN-product-apps-atelier-readme-md-document-atelier-release-output-director-6c9da47260`
...
Source: `harness/actions/workflows/direct-run.md`
...
- `harness/knowledge/decisions/adr/0004-ai-org-llm-doc-consolidation.md` - optional role knowledge matched metadata signals for intent 'Document Atelier release output directory in README'
- `harness/knowledge/incidents/README.md` - known problem or incident matched metadata signals
- `harness/knowledge/rules/intelligence/intelligence-harness-memory-model.md` - optional role knowledge matched metadata signals for intent 'Document Atelier release output directory in README'
...
`atelier run close RUN-product-apps-atelier-readme-md-document-atelier-release-output-director-6c9da47260`
