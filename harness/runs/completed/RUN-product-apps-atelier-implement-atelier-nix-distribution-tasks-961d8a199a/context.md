...
schema: harness/v1
kind: run
id: run.active.run-product-apps-atelier-implement-atelier-nix-distribution-tasks-961d8a199a.context
title: "RUN-product-apps-atelier-implement-atelier-nix-distribution-tasks-961d8a199a Context"
status: active
summary: "Compiled context pack for Implement Atelier Nix distribution tasks: keep external release binary surface, add local dogfood runner, and document source-build bun2nix path"
tags:
  - harness
  - context
---

# Context: RUN-product-apps-atelier-implement-atelier-nix-distribution-tasks-961d8a199a
...
- Intent: Implement Atelier Nix distribution tasks: keep external release binary surface, add local dogfood runner, and document source-build bun2nix path
...
- `harness/knowledge/decisions/adr/0004-ai-org-llm-doc-consolidation.md` - optional role knowledge matched metadata signals for intent 'Implement Atelier Nix distribution tasks: keep external release binary surface, add local dogfood runner, and document source-build bun2nix path'
...
- `harness/knowledge/rules/intelligence/intelligence-harness-memory-model.md` - optional role knowledge matched metadata signals for intent 'Implement Atelier Nix distribution tasks: keep external release binary surface, add local dogfood runner, and document source-build bun2nix path'
...
`atelier run close RUN-product-apps-atelier-implement-atelier-nix-distribution-tasks-961d8a199a`
