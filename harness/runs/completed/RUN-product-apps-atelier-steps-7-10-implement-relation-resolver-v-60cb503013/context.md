...
schema: harness/v1
kind: run
id: run.active.run-product-apps-atelier-steps-7-10-implement-relation-resolver-v-60cb503013.context
title: "RUN-product-apps-atelier-steps-7-10-implement-relation-resolver-v-60cb503013 Context"
status: active
summary: "Compiled context pack for Steps 7-10: Implement Relation Resolver, Validator, Affordance Pipeline, Meta-workflow harnessization"
tags:
  - harness
  - context
---

# Context: RUN-product-apps-atelier-steps-7-10-implement-relation-resolver-v-60cb503013
...
- Intent: Steps 7-10: Implement Relation Resolver, Validator, Affordance Pipeline, Meta-workflow harnessization
...
- `harness/runs/active/RUN-product-apps-atelier-steps-7-10-implement-relation-resolver-v-60cb503013`
...
`atelier run close RUN-product-apps-atelier-steps-7-10-implement-relation-resolver-v-60cb503013`
