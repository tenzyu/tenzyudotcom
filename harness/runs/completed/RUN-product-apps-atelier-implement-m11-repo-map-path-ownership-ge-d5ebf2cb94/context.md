...
schema: harness/v1
kind: run
id: run.active.run-product-apps-atelier-implement-m11-repo-map-path-ownership-ge-d5ebf2cb94.context
title: "RUN-product-apps-atelier-implement-m11-repo-map-path-ownership-ge-d5ebf2cb94 Context"
status: active
summary: "Compiled context pack for Implement M11 (repo-map + path-ownership generation) and M12 (optional semantic expansion) to release quality; no worktree, no release ceremony"
tags:
  - harness
  - context
---

# Context: RUN-product-apps-atelier-implement-m11-repo-map-path-ownership-ge-d5ebf2cb94
...
- Intent: Implement M11 (repo-map + path-ownership generation) and M12 (optional semantic expansion) to release quality; no worktree, no release ceremony
...
- `harness/runs/active/RUN-product-apps-atelier-implement-m11-repo-map-path-ownership-ge-d5ebf2cb94`
...
`atelier run close RUN-product-apps-atelier-implement-m11-repo-map-path-ownership-ge-d5ebf2cb94`
