...
schema: harness/v1
kind: run
id: run.active.run-product-apps-atelier-clean-up-atelier-nix-distribution-change-abd3e5087f.context
title: "RUN-product-apps-atelier-clean-up-atelier-nix-distribution-change-abd3e5087f Context"
status: active
summary: "Compiled context pack for Clean up Atelier Nix distribution changes, remove obsolete files, and optimize release workflow and package wiring"
tags:
  - harness
  - context
---

# Context: RUN-product-apps-atelier-clean-up-atelier-nix-distribution-change-abd3e5087f
...
- Intent: Clean up Atelier Nix distribution changes, remove obsolete files, and optimize release workflow and package wiring
...
`atelier run close RUN-product-apps-atelier-clean-up-atelier-nix-distribution-change-abd3e5087f`
