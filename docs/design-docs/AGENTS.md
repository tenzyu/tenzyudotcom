...
2. [Security & Safety](#2-security-safety)
   ...
   - 2.3 [Security: Env Parsing & Centralization](#23-security-env-parsing-centralization)
   - 2.4 [Structural & Mutation Guards](#24-structural-mutation-guards)
   - 2.5 [Security: Outbound Boundary & Zero Trust](#25-security-outbound-boundary-zero-trust)
3. [Implementation](#3-implementation)
   ...
   - 3.8 [Next.js Routing Conventions](#38-next-js-routing-conventions)
4. [UI & UX](#4-ui-ux)
...
### 2.3 Security: Env Parsing & Centralization <a id="23-security-env-parsing-centralization"></a>
...
### 2.5 Security: Outbound Boundary & Zero Trust <a id="25-security-outbound-boundary-zero-trust"></a>
...
### 3.8 Next.js Routing Conventions <a id="38-next-js-routing-conventions"></a>
