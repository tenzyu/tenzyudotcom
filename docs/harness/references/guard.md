...
4. 実行中は structure / mutation / tool boundary を監視する
5. harness gap が見えたら docs 更新か follow-up debt 化を判断する
6. docs を更新した場合は、rule のまとまり方と思想競合を review する
7. 最終報告で structural decision と未検証事項を明示する
