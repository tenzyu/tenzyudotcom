...
`docs/harness/*.md` は、軽量な decision record を保持する。
...
full spec を維持する場所ではない。

### Case Memory

`docs/harness/cases/*.md` は、具体知の集積として扱う。
...
要するに、harness が rule を持ち、
`cases` が case と evidence を持つ。

### Repo-Specific Memory

`docs/harness/repo-specific/*.md` は、
この repo 固有の durable spec を扱う。
