...
import { analyzeImportBoundaries } from './lint-import-boundaries'
...
describe('lint-import-boundaries', () => {
  let tempDir: string
...
export default function Page() {
  ...
  test('reports cross-route _features dependencies', () => {
    expect(issues).toContainEqual({
      ruleName:
        'Route-local _features under src/app/[locale]/(main)/pointers/_features must not depend on another route-local _features slice.',
