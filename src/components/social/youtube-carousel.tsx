  ...
  <DialogContent
    className={cn(
      ...
      isShort
        ...
        : 'min-w-screen border-black bg-black p-0 md:min-w-[90vw] md:border-white md:bg-white md:p-4',
    )}
  >
    <VisuallyHidden>
  ...
  return (
    <div className={cn('mx-auto w-full', isShort ? 'max-w-3xl' : 'max-w-4xl')}>
      ...
      >
        ...
        <CarouselPrevious
          className={cn(
            'absolute top-1/2 z-10 -translate-y-1/2 transform dark:bg-black dark:font-white',
